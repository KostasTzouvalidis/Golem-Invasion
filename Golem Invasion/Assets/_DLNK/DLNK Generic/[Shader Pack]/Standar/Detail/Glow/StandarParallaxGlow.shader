...
/////// Vectors:
                ...
                float4 _ParallaxMap_var = tex2D(_ParallaxMap,TRANSFORM_TEX(i.uv0, _ParallaxMap));
                float2 node_6449 = ((_Parallax*(_ParallaxMap_var.a - 0.5)*mul(tangentTransform, viewDirection).xy + i.uv0).rg*_MainTiling);
