...
Shader "DLNK/Standar/TopBottomRelief" {
    Properties {
        ...
        _IBLAmbient ("IBL Ambient", Float ) = 0
...
///////// Gloss:
                float4 _TopSpecTex_var = tex2D(_TopSpecTex,TRANSFORM_TEX(node_8520, _TopSpecTex));
...
/////// Diffuse:
                ...
                float3 indirectDiffuse = float3(0,0,0);
                    ...
                    #endif
                #endif
                indirectDiffuse += (node_3938*_IBLAmbient); // Diffuse Ambient Light
                #if SHOULD_SAMPLE_SH_PROBE
